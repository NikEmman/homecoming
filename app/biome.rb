  ...
  class << self
    ...
    def number_three(args)
      ...
      args.state.furniture ||= [Furniture.single_sofa_right(args, 5, 1),
                                ...
                                Furniture.sofa_front(args, 6, 3),
                                Furniture.table_small(args, 6, 1, 2),
                                ...
                                Furniture.mirror(args, 6, 6.2, 2),

                                Furniture.stairs_front(args, 11.1, 5.4, 2),
                                Furniture.bathtub(args, 14, 4, 2),
                                Furniture.toilet_left(args, 15.1, 5),
                                Furniture.sink(args, 13, 6, 2),

                                Furniture.chair_right(args, 2, 3, 2),
                                Furniture.chair_right(args, 2, 4, 2),
                                Furniture.chair_front(args, 1, 4, 2),
                                Furniture.dinning_table_vertical(args, 1, 3),
                                Furniture.flowerpot(args, 1.5, 3.8),
